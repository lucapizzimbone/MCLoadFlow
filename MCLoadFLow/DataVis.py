...
CLUSTERS = False # for future use. For the moment shall be False
...
voltage_df = pd.read_csv(PATH + r'\res_prob_lf_bus.csv')
lne_loading_df = pd.read_csv(PATH + r'\res_prob_lf_lne_loading.csv')
lne_power_df = pd.read_csv(PATH + r'\res_prob_lf_lne_power.csv')
trafo_loading_df = pd.read_csv(PATH + r'\res_prob_lf_trf.csv')
p_rand_df = pd.read_csv(PATH + r'\res_prob_lf_load_power.csv')
grid_losses_df = pd.read_csv(PATH + r'\res_prob_lf_power_losses.csv')
vrewi_power_df = pd.read_csv(PATH + r'\res_prob_lf_power_vre_wind.csv')
vrepv_power_df = pd.read_csv(PATH + r'\res_prob_lf_power_vre_pv.csv')
if CLUSTERS:
    cluster_df = pd.read_csv(PATH + r'\res_prob_lf_clusters.csv')
